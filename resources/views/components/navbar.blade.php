        ...
        <ul class="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 justify-content-center align-items-center align-items-sm-start"
            ...
            <li class="nav-item">
                <a href="{{ route('createAbsence') }}" class="nav-link px-sm-0 px-2">
                    <i class="fs-5 bi-calendar-date"></i><span class="ms-2 d-none d-sm-inline">Urlaub einreichen</span>
                </a>
            </li>
            <li>
                <a href="{{ route('showAbsences') }}" class="nav-link px-sm-0 px-2">
                    <i class="fs-5 bi-cloud-sun"></i><span class="ms-2 d-none d-sm-inline">Urlaubsübersicht</span> </a>
            </li>
